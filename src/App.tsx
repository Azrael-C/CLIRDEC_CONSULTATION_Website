 ...
 return <main className="auth">
  ...
  <section className="auth-panel">
   <form className={creating?"login student-signup":"login"} onSubmit={creating?signup:login}>
    ...
    {creating?<><h2>Create a student account</h2><p className="muted">Register as a student to request faculty consultations. Faculty and administrator accounts are issued only by MISO.</p></>:<><h2>Log in to your portal</h2><p className="muted">Students, faculty, and administrators use the same secure sign-in.</p></>}
